...
/**  
 * @brief Build a min double heap using heap DS 
...
/**  
 * @brief Enqueue an Item to the heap and sorting by min.  
...
/**  
 * @brief retrive the min value in the Heap.  
 * @param[in] _heap - Heap to operate on.
 * @param[out] _pItem - pointer to variable that will receive the Min item
 * @return success or error code 
 */
Heap_Result Heap_Min(Heap* _heap, void* *_data);


/**  
 * @brief retrive and remove the min value in the Heap.  
 * @param[in] _heap - Heap to operate on.
 * @param[out] _pItem - pointer to variable that will receive the Min item
 * @return success or error code 
 */
Heap_Result Heap_ExtractMin(Heap* _heap, void* *_data);
